...
import { campaignCategoriesColumns as columns } from './campaign-categories-columns'

type CampaignCategoriesTableProps = {
  campaignCategories: Paginated<CampaignCategory>
  search: Record<string, unknown>
}

export function CampaignCategoriesTable({
  campaignCategories,
  search,
}: CampaignCategoriesTableProps) {
  ...
  useEffect(() => {
    ensurePageInRange(campaignCategories.last_page)
  }, [campaignCategories.last_page, ensurePageInRange])
  ...
  return (
    ...
    >
      ...
      {campaignCategories.from && campaignCategories.to && (
        <p className="px-1 text-sm text-muted-foreground">
          Showing {campaignCategories.from}–{campaignCategories.to} of{' '}
          {campaignCategories.total} categories
        </p>
      )}

      <DataTablePagination
        pagination={campaignCategories}
        search={search}
        indexUrl={campaignCategoriesIndex.url()}
        defaultPerPage={20}
        className="mt-auto"
      />
