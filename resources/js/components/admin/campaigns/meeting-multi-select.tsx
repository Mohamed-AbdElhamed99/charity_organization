...
export type MeetingSelectOption = {
  value: string
  label: string
}

type MeetingMultiSelectProps = {
...
export function MeetingMultiSelect({
  options,
  value,
  onChange,
  error,
}: MeetingMultiSelectProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {options.length === 0 && (
        <p className="text-muted-foreground text-sm">No meetings available.</p>
      )}
