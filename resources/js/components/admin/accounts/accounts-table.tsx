...
import { accountTypeOptions, statusOptions } from './data/data'
...
export function AccountsTable({
  ...
  useEffect(() => {
    ensurePageInRange(accounts.last_page)
  }, [accounts.last_page, ensurePageInRange])
