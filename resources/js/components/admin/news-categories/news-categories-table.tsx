...
import { newsCategoriesColumns as columns } from './news-categories-columns'
...
export function NewsCategoriesTable({
  ...
  useEffect(() => {
    ensurePageInRange(newsCategories.last_page)
  }, [newsCategories.last_page, ensurePageInRange])
  ...
  return (
    ...
    >
      ...
      {newsCategories.from && newsCategories.to && (
        <p className="px-1 text-sm text-muted-foreground">
          Showing {newsCategories.from}–{newsCategories.to} of{' '}
          {newsCategories.total} categories
        </p>
      )}

      <DataTablePagination
        pagination={newsCategories}
        search={search}
        indexUrl={newsCategoriesIndex.url()}
        defaultPerPage={20}
        className="mt-auto"
      />
