...
import { TransactionsDialogs } from '@/components/admin/transactions/transactions-dialogs'
import { TransactionsPrimaryButtons } from '@/components/admin/transactions/transactions-primary-buttons'
import { TransactionsProvider } from '@/components/admin/transactions/transactions-provider'
...
export default function TransactionsIndex() {
  const { transactions, accounts, currencies, paymentMethods, search } =
