...
export default function NewsIndex() {
  ...
  return (
    <>
      <Head title={t.newsPage.pageTitle} />
        ...
        <div className="mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col gap-10 md:flex-row md:items-start md:gap-12">
            ...
            <CategorySidebar
              ...
              allLabel={t.newsPage.allCategories}
              categoriesLabel={t.newsPage.categories}
              dir={dir}
              ...
              {news.data.length > 0 ? (
                <>
                  <p className="mb-6 text-sm text-body-text/60">
                    {news.total} {locale === "ar" ? "مقال" : "articles"}
                  </p>
...
NewsIndex.layout = (page: React.ReactNode) => <SiteLayout transparentHeader={false}>{page}</SiteLayout>;
