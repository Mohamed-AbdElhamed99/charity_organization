...
class FinancialSeeder extends Seeder
{
    ...
    {
        $account = BankAccount::where('type', 'bank')->first();
        ...
        foreach (range(1, 60) as $i) {
            ...
            Donation::create([
                ...
                'stripe_payment_intent_id' => $method?->code === 'stripe' ? 'pi_'.Str::random(24) : null,
                'stripe_charge_id' => $method?->code === 'stripe' ? 'ch_'.Str::random(24) : null,
        ...
        foreach (range(1, 25) as $i) {
            ...
            Transfer::create([
                'transaction_id' => $transaction->id,
                'campaign_id' => $campaign?->id,
                'recipient_type' => $isBeneficiary ? Beneficiary::class : null,
                'recipient_id' => $isBeneficiary ? $beneficiary->id : null,
                'recipient_label' => $isBeneficiary ? null : fake()->name(),
